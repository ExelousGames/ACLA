...
family: MS
common_co_labels: [MS7, MS16, MS47, MS11]
causes_to_check: [MS5]
---
...
understeers wide (MS47, MS16) or has to be tucked back with extra
steering correction that scrubs speed.

## Telemetry signature
- Steering input starts earlier than expert.
- Apex position sits earlier in the corner (pairs with MS7).
- Exit trajectory wider than expert (MS16).
- Often follows MS5 — the brake came off early and the driver
...
- If brake came off too early (MS5), fix that first; the wheel
  follows.

...
family: MS
common_co_labels: [MS2, MS9, MS10, MS16]
causes_to_check: [MS2, MS9, MS1]
---
...
- Exit trajectory wider than expert (often MS16).

## Engineer interpretation
A late apex is rarely the cause — it's the result. Find what
happened earlier: a late brake (MS1), a late turn-in (MS2), or a

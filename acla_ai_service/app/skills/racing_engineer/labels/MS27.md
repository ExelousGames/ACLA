...
family: MS
common_co_labels: [MS18, MS32, MS3]
causes_to_check: [MS18]
---
...
- May pair with MS18 (slow release) or MS17 (fast release once it
  finally starts).
...
- If the peak feels like it has to last to manage the entry speed,
  the peak is too low (MS13) — go in firmer, off sooner.

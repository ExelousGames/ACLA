...
(MSP5) cost time on the straight.

## Physics
Later brake captures more of the available straight-line
acceleration. The brake phase shortens; the peak may climb (MSP22
...
- Peak brake pressure may rise (manage so it doesn't hit MSP22).
...
- Watch peak brake (MSP22) — don't compensate with stab pressure.

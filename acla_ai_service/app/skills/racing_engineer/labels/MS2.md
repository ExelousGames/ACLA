...
family: MS
common_co_labels: [MS3, MS10, MS16, MS9]
causes_to_check: [MS1, MS22]
---
...
- Apex hit later in the corner (pairs with MS3).
- Exit trajectory wider than expert (MS16) — the line was wrong from
  the start.

...
brake (MSP1) caused an off or a destroyed corner.

## Physics
Earlier brake reduces the peak pressure needed (MSP22 doesn't
fire), gives more distance to bleed off the trail-brake (MSP17

...
brake (MS1) caused an off or a destroyed corner.

## Physics
Earlier brake reduces the peak pressure needed (MS22 doesn't
fire), gives more distance to bleed off the trail-brake (MS17

...
family: MS
common_co_labels: [MS26, MS46, MS47, MS43]
causes_to_check: [MS20]
---
...
on power exits or power oversteer (MS46) on RWD cars.
...
budget; the rear slides (MS46) or the front pushes wide (MS47) as
...
- Pairs with MS26 (overshoot to full throttle).
...
- If wheelspin is repeatable, check that throttle-on isn't too
  early (MS20) — the right *amount* of throttle at the wrong
  *time* is still wrong.

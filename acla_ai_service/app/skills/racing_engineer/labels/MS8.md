...
family: MS
common_co_labels: [MS21, MS19, MS3, MS11]
causes_to_check: [MS3]
---
...
- Throttle-on point delayed (often pairs with MS21).
- Peak throttle reached later in the exit (MS19 if it never gets
  there).
...
- If the rear breaks loose when you try it, then the line through
  the apex was tighter than it needed to be (MS9 / MS10) — widen
  the apex slightly.

...
trades a brief throttle peak for either wheelspin (MSP46 on RWD)
or push-wide understeer (MSP47 on FWD).
...
- If you need more peak, widen the apex (MSP10) so the car has
  more grip available.

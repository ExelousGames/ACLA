...
family: MS
common_co_labels: [MS38, MS19]
causes_to_check: [MS38]
---
...
- Time delta vs expert grows through the exit and onto the
  straight.
- Usually downstream of MS38 (downshift came too late or didn't
  happen).

## Engineer interpretation
You're in the wrong gear. Either you missed a downshift on entry
(MS38) or your corner-by-corner gear plan is off by one. Add a

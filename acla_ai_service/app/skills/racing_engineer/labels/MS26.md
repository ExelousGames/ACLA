...
family: MS
common_co_labels: [MS15, MS46, MS47]
causes_to_check: [MS15]
---
...
trades a brief throttle peak for either wheelspin (MS46 on RWD)
or push-wide understeer (MS47 on FWD).
...
- If you need more peak, widen the apex (MS10) so the car has
  more grip available.

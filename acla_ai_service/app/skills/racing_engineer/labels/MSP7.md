...
unwind — usually showing up as a wide-exit understeer (MSP16, MSP47)
...
- Exit trajectory tracks wide of expert (MSP16).
- Throttle-on may be late (MSP21) because the line wasn't ready.

## Engineer interpretation
Same diagnosis as MSP6 most of the time — early turn-in produced
early apex. Fix the turn-in marker and the apex normalises. Don't
chase the apex with the wheel; let the line take you there.

## Remedies
- Move turn-in reference later (see MSP6).
- Eyes on exit reference, not on the apex kerb.
- If you keep clipping the apex early even with a good turn-in, the
  brake might be off too early too (MSP5) — check the whole entry
  phase together.

...
family: MS
common_co_labels: [MS16, MS47, MS46]
causes_to_check: [MS47, MS46, MS16]
---
...
## Physics
Exit run-off comes either from understeer (MS47 — front pushes
wide, car can't tighten back) or oversteer (MS46 — rear slide,
driver catches it on the outside kerb) or simply from carrying
too wide a line that runs out of track (MS16). Triggering
...
- Tighter apex (MS10) gives more exit room.

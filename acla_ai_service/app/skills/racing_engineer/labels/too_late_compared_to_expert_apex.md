...
- Exit trajectory wider than expert (often exit trajectory too wide).

## Engineer interpretation
A late apex is rarely the cause — it's the result. Find what
happened earlier: a late brake (initiate brake too late), a late turn-in (initiate the turn too late), or a

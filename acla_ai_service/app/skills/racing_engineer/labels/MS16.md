...
family: MS
common_co_labels: [MS47, MS10, MS3, MS43, MS15]
causes_to_check: [MS47, MS10, MS20]
---
...
the line (MS47 understeer at exit), forcing the driver to use more
track to manage the radius, or the driver opened the throttle too
early (MS20 / MS15) and let weight transfer push the front wide.
...
Two questions: is the car not turning (MS47), or are you not letting
it turn (early throttle, MS20)? The fix depends on the cause.
...
- Tighter apex (MS10) gives the front more room at exit.

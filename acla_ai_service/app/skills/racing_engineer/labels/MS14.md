...
family: MS
common_co_labels: [MS22, MS44, MS17]
causes_to_check: [MS1]
---
...
- Often paired with MS22 (over-shoots the peak too) and MS44
  (rear lets go).
...
- If you're stamping because you're late (MS1 upstream), fix the
  reference first.

...
back onto track speed). Stationary time during a stop is also PS.

## How to read PS segments
...
behaviour (RM segments often follow).

## Engineer interpretation
Don't drill into telemetry deltas for PS segments — they will look
"wrong" by design. Useful coaching is at the boundaries: smooth

...
# app/external_knowledge_base/ → repo root (acla_ai_service) is 2 parents up.
_CACHE_DIR = _PACKAGE_ROOT.parents[1] / ".cache" / "racing_knowledge_llama"
...
class KnowledgeRegistry:
    ...
    def _build_or_load_index(self) -> None:
        ...
        from app.external_knowledge_base._embedder import get_llama_embedding

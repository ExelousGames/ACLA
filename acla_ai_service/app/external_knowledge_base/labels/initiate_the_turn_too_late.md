...
- Apex hit later in the corner (pairs with too late compared to expert apex).
- Exit trajectory wider than expert (exit trajectory too wide) — the line was wrong from
  the start.

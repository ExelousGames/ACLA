...
stability (release brake too quickly).
...
- May pair with release brake too slowly (slow release) or release brake too quickly (fast release once it
  finally starts).
...
- If the peak feels like it has to last to manage the entry speed,
  the peak is too low (highest brake pressure too low) — go in firmer, off sooner.

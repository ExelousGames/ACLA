...
description: >
  ...
  with definitions and optional solutions. Use only for live or recorded raw
  telemetry windows, such as "what just happened", "why did I lose time there
  on this lap", or "how was lap N".
parameters:
  scope:
...
When the tool returns labels with definitions and optional solutions, pick the
one or two that matter most and explain them in natural race-engineer language.

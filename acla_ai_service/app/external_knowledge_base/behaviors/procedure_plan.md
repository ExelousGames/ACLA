...
- When a tool result, session context update, or user message confirms the
  current request is complete, ready, or executable now, call
  `advance_plan_step` before speaking. Do not merely acknowledge the update.

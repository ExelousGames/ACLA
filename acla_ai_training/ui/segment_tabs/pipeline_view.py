...
from training.pipelines.manifest.dataset_structure import (
    has_cached_data,
    is_segment_record,
    payload_records,
)
from training.pipelines.manifest.registry import save as save_pipeline, slugify
from training.pipelines.manifest.migrate_labels import migrate_dataset_labels
from training.pipelines.manifest.protection import collect_protected_session_ids
from training.pipelines.manifest.segment_refresh import refresh_node_segments
        ...
        with st.form("prepare_data_form"):
            if st.form_submit_button("Start data preparation", width="stretch"):
                cmd = [
                    ...
                    "-u",
                    "-m",
                    "training.pipelines.training.prepare_training_data",
                ]

...
def run_split(
    ...
    from training.shared.annotation_agent_tools import split_lap_by_circuit_sections
...
def render_lap_panel(
    ...
    """
    from training.shared.annotation_agent_tools import get_opponent_splitter_rule_signature

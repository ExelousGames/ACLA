...
Public annotation pipeline entry — the only function the UI calls.
    ...
    from training.local_annotation_agent.workflow import (
        run_annotation,
...
from training.local_annotation_agent.workflow.deterministic import (
    calculate_detailed_annotation,
    calculate_lap_annotation,
)
from training.local_annotation_agent.workflow.results import (
    AnnotationResult,
    LapAnnotationResult,
)
...
class AnnotationPipelineConfig:
    ...
    def to_provider_config(self) -> ProviderConfig:
        ...
        from training.annotation_providers.registry import get_annotation_provider
...
def run_claude_followup(**kwargs):
    ...
    from training.local_annotation_agent.workflow.followup import run_claude_followup as _run
    return _run(**kwargs)

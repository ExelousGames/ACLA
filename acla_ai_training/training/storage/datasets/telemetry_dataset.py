...
Lives in training/storage/datasets/ alongside the segment-classifier
...
in :mod:`training.storage.datasets.lance_telemetry_dataset`; this class is
...
from app.ml.transformer.scaler import PerFeatureScaler, _RunningFeatureStats

...
A drop-in replacement for :class:`training.storage.datasets.telemetry_dataset.TelemetryActionDataset`
...
from training.storage.lance.strategies import SegmentsStrategy, strategy_for

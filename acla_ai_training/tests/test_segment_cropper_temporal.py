...
from training.ml.segment_cropper.data import (
    CropperSequence,
...
from training.ml.segment_cropper.calibration import (
    ValidationProbabilities,
    calibrate_thresholds,
    evaluate_thresholds,
)
from training.ml.segment_cropper.trainer import SegmentCropperTrainer
...
def test_calibration_prioritizes_precision_at_target_recall_and_falls_back(monkeypatch):
    ...
    monkeypatch.setattr(
        "training.ml.segment_cropper.calibration.evaluate_thresholds",
        target_metrics,
    )

...
import training.pipelines.training.pipeline.enrich as enrich_pipeline
...
from training.pipelines.training.pipeline.enrich import enrich_sessions_with_context
...
async def test_pipeline_builds_uploads_and_reuses_local_reference(
    ...
    class LocalReference:
        async def build_from_cached_top_laps(self, cache_key, *, telemetry_store):
            events.append(("build", cache_key, telemetry_store))

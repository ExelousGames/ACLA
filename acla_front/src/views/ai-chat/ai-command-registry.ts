...
import { detectOvertakeTacticalState } from '../live-session/session-intelligence/overtake-agent-detector';
import {
...
import { isLiveSessionAiAvailable, type RecordingState } from 'views/live-session/recording-state';
import type {
    WorkflowDispatcher,
    OperationKind,
    WorkflowPanelHandle,
...
import type { BaselineCollectionHandle } from 'views/live-session/baseline-collection/BaselineCollection';
...
import type { SessionAnalysisHandle } from 'views/recorded-session/session-analysis';
...
} from 'views/session-shared/visualization/charts/AnalysisResultsChart';
import type {
    ApplyAnalysisResultQueryInput,
    QueryLapAnalysisResultInput,
    QueryLapAnalysisResultOutput,
} from 'views/session-shared/visualization/charts/analysisResultsQuery';
import { getSingletonVisualizationComponentName } from 'views/session-shared/visualization/visualization-component-names';
import type { QueryResult, QueryScope } from 'views/session-shared/session-intelligence/types';
...
import type { CreateLiveRangeTodoListInput } from 'views/live-session/ai-operations/live-range-todo-list-types';

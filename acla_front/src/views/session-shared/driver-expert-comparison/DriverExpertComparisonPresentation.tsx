...
export interface DriverExpertComparisonPresentationProps {
...
const useReplayTimeline = (
    ...
    }, [animationDurationMs, replay, replayRequest]);
...
export const DriverExpertComparisonPresentation: React.FC<DriverExpertComparisonPresentationProps> = ({
    data,
    labelGroups,
    labelRanges,
    title,
    ...
    onReplayStarted,
    onReplayStopped,
    completedStatusLabel = 'Replay complete',
}) => {
...
const DriverExpertComparisonOverlayGraph = React.memo<{
    ...
    <DriverExpertComparisonPresentation
        ...
        onReplayStarted={() => context.emitRendererEvent('replay_started')}
...
export default DriverExpertComparisonPresentation;

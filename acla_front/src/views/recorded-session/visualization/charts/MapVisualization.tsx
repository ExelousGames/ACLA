...
import { VisualizationProps } from 'views/session-shared/visualization/visualization-types';
import { NamedOperationComponentHandle } from 'contexts/OperationComponentRefContext';
import { runVisualizationBooleanCallback } from '../../../session-shared/visualization/visualization-component-callbacks';
...
} from '../../../session-shared/visualization/charts/circuitTrackLayout';
import {
    CarPoint,
    ...
    Vec3,
    VisibilitySample
} from '../../../session-shared/visualization/charts/mapTelemetry';
import {
    getSegmentTrackSectionText,
    resolveActiveSegmentLabelTexts,
    resolveSegmentLabelTexts,
    SegmentClassificationSegment
} from '../../../session-shared/visualization/charts/segmentClassificationDisplay';
import {
    RecordedActiveSegmentSummary,
} from 'views/recorded-session/recorded-session-analysis';
import {

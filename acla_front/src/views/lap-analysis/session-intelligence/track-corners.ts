...
export const TRACK_CORNERS: Record<string, CornerDefinition[]> = {
    ...
    brands_hatch: [
        ...
        { name: 'T5 Hawthorn Bend', from: 0.64, to: 0.70 },
        { name: 'T6 Westfield Bend', from: 0.74, to: 0.78 },
        { name: 'T7 Sheene Curve', from: 0.82, to: 0.86 },
        { name: 'T8 Stirlings', from: 0.88, to: 0.92 },
